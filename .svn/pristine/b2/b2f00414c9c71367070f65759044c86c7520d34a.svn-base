...
{
    public class SpCompareEmpExpenseCeilingController : Controller
    {
        //
        // GET: /SpCompareEmpExpenseCeiling/
        ...
        //
        // GET: /SpCompareEmpExpenseCeiling/Details/5

        public JsonResult GetReport(DateTime? InFromDate, DateTime? InToDate)
        {
            DataTable dt = CommonUtils.Call_SpCompareEmpExpenseCeiling(InFromDate, InToDate);
            if (dt != null && dt.Rows != null && dt.Rows.Count != 0)
            {
                string strReportName = "rptCompareEmpExpenseCeiling";
